...
Prepare_Client() {
	...
	cmd="qemu-system-x86_64 -cpu host,-vmx -smp $NestedCpuNum -m $NestedMemMB -hda /mnt/resource/$CLIENT_IMAGE \
...
Prepare_Server() {
	...
	mac_addr1=$(generate_random_mac_addr)
	mac_addr2=$(generate_random_mac_addr)
	cmd="qemu-system-x86_64 -cpu host,-vmx -smp $NestedCpuNum -m $NestedMemMB -hda /mnt/resource/$SERVER_IMAGE \
